	...
	$(document).ready(function(){
		...
		Handlebars.registerHelper("eqReplyer", function(replyer, rv_num) {
			...
			if (replyer == "${user.mem_id}") {
				btnHtml = "<a class='btn btn-primary btn-xs' data-toggle='modal' data-target='#modifyModal' style='color:white;'>"
					  + "MODIFY</a>"
							...
							<div class="box-body">
								...
								<div>
									<!-- 상품후기쓰기 부분 -->
									 ...
									 <%-- Modal : 상품후기 수정/삭제 팝업 --%>
									<div id="modifyModal" class="modal modal-primary fade" role="dialog" style="opacity:1;">
